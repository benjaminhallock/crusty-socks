...
const Navbar = ({ isLoggedIn, onLogout, user }) => {
  ...
  return (
    <nav className='fixed top-0 left-0 right-0 p-2 bg-gradient-to-r from-purple-800 via-purple-500 to-purple-900/50 dark:from-gray-900 dark:via-purple-500 dark:to-indigo-500/50 backdrop-blur-lg shadow-lg z-50'>
