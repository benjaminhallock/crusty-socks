const buttonVariants = ({
  ...
  const baseClasses =
    "rounded-md font-medium transition-all relative overflow-hidden group disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center justify-center";
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "disabled:before:hidden", // Disable shine effect when button is disabled
