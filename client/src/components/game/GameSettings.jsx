      ...
      {expanded && (
        <div
          ...
          <div className='p-3 border-b border-gray-200 dark:border-gray-700'>
            <h3 className='text-sm font-medium text-gray-700 dark:text-gray-300'>Game Settings</h3>
          </div>
            ...
            {settings.map(setting => (
              <li
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <span className='text-indigo-600 dark:text-indigo-400'>{setting.value}</span>
                </div>
              </li>
            ))}
          </ul>
