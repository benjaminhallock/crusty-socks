...
const PixelCanvas = ({ lobby, isDrawer }) => {
	...
	// Calculate the number of pixels needed to cover the area
	const pixelsWide = Math.ceil(CANVAS_WIDTH / effectiveGridSize)
	const pixelsHigh = Math.ceil(CANVAS_HEIGHT / effectiveGridSize)
	// Calculate actual canvas dimensions to fit all pixels
	...
	useEffect(() => {
		...
		console.log(`[PixelCanvas] Initializing canvas with grid size: ${effectiveGridSize}`)
			...
			<div className='relative w-full h-full flex flex-col gap-2'>
				...
				<div className='flex flex-wrap gap-2 justify-center'>
					...
					<Button
						...
						className='hidden'
						disabled={true}>
						<FaCheckSquare className={showCheckerboard ? 'text-indigo-600' : 'text-gray-400'} />
					</Button>
