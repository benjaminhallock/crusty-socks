...
const PlayerList = ({ players, drawerUsername, roomId, gameState, currentUsername }) => {
          ...
          {players.map((player, index) => (
              ...
              <span className="score">{player.score}</span>
                ...
                {player.username !== currentUsername && (
                    <button
                        className="bg-red-600 text-white px-2 py-1 rounded-md hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed"
