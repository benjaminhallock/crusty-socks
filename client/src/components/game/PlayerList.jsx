...
import { FaCog, FaCopy, FaUser } from 'react-icons/fa'
...
const PlayerList = ({ lobby, user, onStartGame }) => {
  ...
  const { players, currentDrawer: drawerUsername, roomId, gameState, userId: lobbyUserId } = lobby
    ...
    setContextMenu({
      ...
      options: [
        ...
        },
        {
          ...
          isDestructive: true,
          hidden: isAdmin || lobby.userId === user._id,
        },
      ],
    })
  }
  ...
  const getPlayerStateIndicator = player => {
    ...
    //TODO: add labels for admin, score/prestige.
  }
  ...
  // use a memo to avoid  re-renders
  ...
  {
    gameState === GAME_STATE.WAITING && (lobbyUserId === user._id || isAdmin) && (
      <Button
        onClick={onStartGame}
        title='Start Game'
        variant='primary'
    ...
    <div className='w-full bg-white/95 dark:bg-gray-800/95 p-2 shadow-sm rounded-lg relative flex flex-col transition-colors border border-gray-200/50 dark:border-gray-700/50'>
      <div className='flex justify-between items-center mb-2 px-1'>
        ...
        <div className='flex gap-1'>
          {gameState === GAME_STATE.WAITING && lobby.userId === currentUsername && (
            <Button
          ...
          <li
            ...
            ${
              player.username === currentUsername
                ...
                : player.username === drawerUsername && gameState === GAME_STATE.DRAWING
                ...
                <Dialog.Panel className='w-full max-w-md transform overflow-hidden rounded-lg bg-white dark:bg-gray-800 p-6 shadow-xl transition-all'>
                  ...
                  <div className='space-y-4'>
                    <div className='grid grid-cols-2 gap-4'>
                      ...
                      <div className='bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg'>
                        <div className='text-xs text-gray-500 dark:text-gray-400'>Word Choices</div>
                        <div className='text-sm font-medium text-gray-900 dark:text-gray-100'>
                          {lobby.selectWord}
                        </div>
                      </div>
                      <div className='bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg'>
                        <div className='text-xs text-gray-500 dark:text-gray-400'>Hint Letters</div>
                        <div className='text-sm font-medium text-gray-900 dark:text-gray-100'>
