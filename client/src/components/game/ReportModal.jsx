          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className='mb-4'>
              <p className='text-white mb-2'>
                Reporting: <span className='font-bold'>{reportedUser}</span>
              </p>
            </div>
            ...
            <div className='mb-4'>
              <label className='block text-gray-300 mb-2'>Evidence to Include</label>
              <div className='space-y-2'>
                ...
                {selectedReason === 'Inappropriate Drawing' && canvasState?.data && (
                  <div className='flex items-center'>
                    <input
                      type='checkbox'
                      id='includeDrawing'
            ...
            {includeChatLogs && chatLogs.length > 0 && (
              <div className='mb-6'>
                <label className='block text-gray-300 mb-2'>Recent Chat Messages</label>
                <div className='bg-gray-700 rounded p-3 max-h-32 overflow-y-auto'>
                  {chatLogs.slice(-10).map((message, index) => (
                    ...
                    >
                      <span className='text-indigo-400'>{message.username}: </span>
