  ...
  return (
    <Modal
      ...
      <div className='text-center'>
        <div className='p-4 bg-indigo-50 dark:bg-indigo-900/30 rounded-lg text-black dark:text-white'>
          <h3 className='text-xl font-bold mb-2'>Round Over!</h3>
          <p>
            Leader: <span className='font-bold'>{sortedPlayers[0]?.username}</span> with{' '}
