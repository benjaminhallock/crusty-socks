	...
	return (
		<div className='min-h-screen py-6 px-4 sm:px-6 lg:px-8'>
			<div className='max-w-5xl mx-auto'>
				{/* Header */}
				<div className='text-center mb-6 bg-gray-50/95 py-4 rounded-lg shadow-lg border border-gray-200 dark:bg-gray-800/95 dark:border-gray-700/70 backdrop-blur-md'>
					<h1 className='text-4xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-indigo-500 dark:from-purple-700/90 dark:to-indigo-800/90'>
				...
				{/* Leaderboard Table */}
				<div className='bg-white dark:bg-gray-800/95 rounded-2xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-700'>
					{/* Table Header */}
					<div className='bg-gradient-to-r from-indigo-500/20 to-purple-500/20 dark:from-indigo-900/70 dark:to-purple-900/70'>
						...
						{leaderboard.length > 0 ? (
							leaderboard.map((player, index) => (
								<div
									...
									className={`grid grid-cols-12 py-4 px-6 hover:bg-gray-50 dark:hover:bg-gray-700/70 transition-all duration-200 ${
										index === 0
											? 'bg-yellow-200/50 dark:bg-yellow-400/30'
											: index === 1
											? 'bg-green-500/20 dark:bg-green-700/30'
											: index === 2
											? 'bg-purple-300/50 dark:bg-purple-800/50'
											: index % 2 === 1
											? 'bg-purple-100/70 dark:bg-gray-900/95'
											: ''
									}`}>
									{/* Rank Column */}
